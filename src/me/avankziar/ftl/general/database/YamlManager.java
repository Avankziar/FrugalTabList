package me.avankziar.ftl.general.database;
...
{	
	...
	public void initConfig() //INFO:Config
	{
		...
		addConfig("TabListListValues",
				new Object[] {
				"staff:ftl.tablist.staff",
				"vip:ftl.tablist.vip",
				"default:null"},
				new Object[] {
				"",
				"Listed alle möglichen Tablisten auf. Der Name wird beim Header/Footer, der Sortierung etc. weiter unten wichtig zu Definierung.",
				"Dabei ist vor dem Doppelpunkt der Name der Tabliste.",
				"Hinter dem TabListnamen ist die zugehörige Permission welcher der Spieler haben muss und dies angezeigt bekommen. null ist gleich keine Permission.",
				"Die Gewichtung ist von Oben nach Unten. Bedeutet, das Plugin versucht zuerst zu prüfen ob der Spieler die Oberen TabListen nehmen kann.",
				"",
				"",
				"",
				"",
		...
		addConfig("default.AnimationTime",
				...
				new Object[] {
				"",
				"Die AnimationTime, eine Zahl in Millisekunden, gibt an, in welchen Abständen, die Tabliste für den Spieler aktualisiert wird.",
				"Sie gilt für alle Werte, aka Header/Footer/PlayerList etc.",
				"Die Minimale Zeitangabe ist 200, alles darunter wird auf 200 aufgerundet um Lags zu vermeiden.",
				"",
				"",
				"",
				""});
		addConfig("default.Header",
				...
				"Neben den PlacerHolderApi Replacern werden auch plugineigene Replacer unterstützt.",
				"Die Tablisten sind als TextListen angegeben. Als Standart sind immer hier zwei Werte angegeben. Jedoch kann es mehr oder weniger Angaben geben.",
				"Das Plugin wird von Oben nach Unten diese in einer Schleife durchgegen. Die Aktualisierungszeit wird in der AnimationTime angegeben.",
				"Die Formatierung ist MiniMessage => https://docs.advntr.dev/minimessage/format.html",
				"",
				"",
				"",
				"",
		...
		addConfig("default.Footer",
				...
				"",
				""});
		addConfig("default.PlayerEntry",
				new Object[] {
				"<gray>[<reset>%player_luckperm_primaryrole_display_name%<gray>] %player_luckperm_primaryrole_display_color%%playername%"},
				new Object[] {
				"",
				"Der PlayerEntry oder Spielereintrag, bestimmt der Spieler in der Tabliste dargestellt werden soll.",
				"Neben den PlacerHolderApi Replacern werden auch plugineigene Replacer unterstützt.",
				"Die Tablisten sind als TextListen angegeben. Als Standart sind immer hier zwei Werte angegeben. Jedoch kann es mehr oder weniger Angaben geben.",
				"Das Plugin wird von Oben nach Unten diese in einer Schleife durchgegen. Die Aktualisierungszeit wird in der AnimationTime angegeben.",
				"Die Formatierung ist MiniMessage => https://docs.advntr.dev/minimessage/format.html",
